...
export const skillCategories = [
  {
    ...
    description: 'Pixel-perfect, accessible interfaces that feel fast and look premium.',
    items: [
      'React',
      'Next.js',
      'TypeScript',
  ...
  },
  {
    ...
    items: ['Git & GitHub', 'Docker', 'AWS', 'CI/CD', 'Vercel', 'Postman', 'Figma', 'Linux'],
  },
];
...
export const experiences = [
  ...
  },
  {
    ...
    stack: ['React', 'React Native', 'Node.js', 'Express.js', 'MongoDB', 'TypeScript'],
    responsibilities: [
