...
<html lang="en">
  ...
  <body>
    <div class="card">
      <span class="pill"><span class="dot"></span> API is running on Vercel</span>
      <h1>Muhammad Bilal — Portfolio API</h1>
      <p>This is the backend API for my portfolio contact form.</p>
      <p>Built with Express, MongoDB, and Nodemailer.</p>
      <div class="row">
        <a href="/api/health">/api/health</a>
        <span style="color:#475569">·</span>
        <a href="https://github.com/bilaltayyab121" target="_blank" rel="noreferrer">GitHub →</a>
      </div>
    </div>
  </body>
</html>`);
...
// Database connection is handled per request to avoid timeouts
...
module.exports = async (req, res) => {
  try {
    // Connect to database only when needed (for API routes that need it)
